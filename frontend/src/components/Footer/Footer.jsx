...
import {AiFillTwitterCircle, AiOutlineLink, AiOutlineGithub} from 'react-icons/ai'

const socialLinks = [
  {
    path: "https://github.com/nxelia99",
    icon: <AiOutlineGithub className='group-hover:text-white w-4 h-5' />
  },
  {
    path: 'https://twitter.com/KaiIsVenom',
    icon: <AiFillTwitterCircle className='group-hover:text-white w-4 h-5' />

  },
  {
    path: 'https://nxelia99.github.io/Portfolio/',
    icon: <AiOutlineLink className='group-hover:text-white w-4 h-5' />
  },
  {
    path: 'www.linkedin.com/in/noelia-fdez-lópez-659818215',
