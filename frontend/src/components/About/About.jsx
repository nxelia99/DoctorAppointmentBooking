...
function About() {
  return <section className='container'>
    <div className="flex justify-between gap-[50px] lg:gap-[13px] xl:gap-0 flex-col lg:flex-row">
        {/* about image */}
        <div className="relative w-3/4 lg:w-1/2 xl:w-[770px] z-10 order-2 lg:order-1">
            <img src={aboutImg} alt="doctor image" />
        ...
        <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
            ...
            as one of the best public hospotials in the Nation and #1 in Europe.</p>

            <p className="text__para mt-[30px] mb-[25px]">Our best is something we strive for each day,
