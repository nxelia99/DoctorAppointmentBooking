        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <div className="mb-5">
              ...
              className='w-full py-3 border-b pr-4 border-salid border-[#0066ff61] 
              ...
              <div className="mb-5 flex items-center justify-between">
                <label className='text-headingColor font-bold text-[16px]
                 leading-7'>
                  Are you a:
                  <select name="role" className='text-textColor text-[15px] leading-7
                 ...
                 leading-7'>
                  Gender:
                  <select name="gender" id="" className='text-textColor text-[15px] leading-7
                  px-4 py-3 focus:outline-none'
              ...
              <div className='mb-5 flex items-center gap-3'>
                ...
                border-solid border-primaryColor flex items-center
                justify-center'>
                  <img src={avatar} className='rounded-full w-full' alt="" />
                </figure>

                <div className='relative w-[160px] h-[50px] cursor-pointer'>
                  <input type="file" 
                  name='photo' 
                  id='customFile'
                  accept='.jpg, .png, .jpeg'
                  ...
                  <label htmlFor="customFile" className='abosulte top-0 left-0 w-full h-full
                  ...
                  truncate cursor-pointer'>Upload photo
