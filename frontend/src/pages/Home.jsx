  ...
  return (
    ...
    <div>
      ...
      <div className="lg:w-[470px] mx-auto">
        <h2 className="heading text-center">Providing de best medical services.</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
        ...
        <div className="mt-[30px]">
          <h2 className="text-[26px] text-headingColor font[700] text-center"> 
          Find a doctor.
          </h2>
      ...
      <div className='container'>
        <div className="flex items-center justify-between flex-col lg:flex-row">
          ...
          <div className='xl:w-[670px]'>
            <h2 className="heading">Get a virtual treatment. <br />anytime.</h2>
            <ul className="pl-4">
          ...
          mt-[50px] lg:mt-0">
            <img src={featureImg} className="w-3/4" alt="doctor image" />
            <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 
            md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:pb-[26px] rounded-[10px]'>
              <div className="flex items-center justify-between">
                ...
                <span className="w-5 h-5 lg:w-[34px] lg:h-[34px] flex items-center justify-enter bg-yellowColor rounded
              ...
              text-[8px] leading-[8px] lg:text-[12px] text-irisBlueColor font-[500] mt-2
              lg:mt-4 rounded-full">Consultation</div>
              <div className="flex items-center gap-[6px] lg:gap-[10px] mt2 lg:mt-[18px]">
                <img src={avatarIcon} alt="" />
                <h4 className='text-[10px] lg:text-[16px]
                 font-[700]'>Wayne Collins</h4>
              </div>
            </div>
          </div>
        </div>
